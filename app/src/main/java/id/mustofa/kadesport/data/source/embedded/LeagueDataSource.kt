...
class LeagueDataSource {
  ...
  fun getLeagues() = listOf(
    League(
      ...
      """.trimIndent(),
      badgePath = R.drawable.english_premier_league
    ),
    League(
      id = 4334,
      name = "French Ligue 1",
      ...
      """.trimIndent(),
      badgePath = R.drawable.french_ligue_1
    ),
    League(
      id = 4331,
      ...
      """.trimIndent(),
      badgePath = R.drawable.german_bundesliga
    ),
    League(
      id = 4332,
      ...
      """.trimIndent(),
      badgePath = R.drawable.italian_serie_a
    ),
    League(
      id = 4335,
    ...
    League(
      ...
      """.trimIndent(),
      badgePath = R.drawable.american_mayor_league
    ),
    League(
      id = 4344,
      ...
      """.trimIndent(),
      badgePath = R.drawable.portugeuese_premiera_liga
    ),
    League(
      id = 4356,
      ...
      """.trimIndent(),
      badgePath = R.drawable.australian_a_league
    ),
    League(
      id = 4330,
      ...
      """.trimIndent(),
      badgePath = R.drawable.scotish_premier_league
    ),
    League(
      id = 4396,
      ...
      description = """
        ...
        Siomilarly, the four clubs that finished at the bottom of Football League One are relegated to Football League Two and are replaced by the top three clubs and the club that won the 4th–7th place play-offs in that division.
      ...
      """.trimIndent(),
      badgePath = R.drawable.english_league_1
    )
  )
}